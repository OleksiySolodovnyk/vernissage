<?php
	...
	?>
		...
		.nivo-caption {
			...
			top: 177px;
			left: -16px;
			padding: 20px 25px 44px 38px;
			background: url('<?php bloginfo('template_directory'); ?>/images/slogan-bg.png') repeat transparent;
		...
		.nivo-caption span {
			color: #fff;
			font-size: 30px;
			font-family: CharterBlC, Times New Roman;
		}
		.nivo-caption p {
			color: #dacec4;
			font-size: 13px;
