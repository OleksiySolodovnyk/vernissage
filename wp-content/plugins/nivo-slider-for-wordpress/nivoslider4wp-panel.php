    ...
    <table class="widefat" cellspacing="0">
      ...
      <tfoot>
        <tr>
          ...
          <th scope="col"><?php _e('Head, Caption and Link','nivoslider4wp'); ?></th>
          <th scope="col"></td>
        </tr>
      </tfoot>
      ...
      <tbody id="table-1">
		...
		<td class="manage-column column-numero orderNumber"><?php echo $item->nivoslider4wp_order; ?></td>
          ...
          <td>
		  <strong><?php echo stripslashes($item->nivoslider4wp_head_headline); ?></strong><br />
		  <strong><?php echo stripslashes($item->nivoslider4wp_text_headline); ?></strong><br />
			<br />
	...
	<table class="widefat disabled" cellspacing="0">
      ...
      <tbody id="table-1">
		...
		<td>x</td>
          ...
          <td>
		  <strong><?php echo stripslashes($item_desable->nivoslider4wp_head_headline); ?></strong><br />
		  <strong><?php echo stripslashes($item_desable->nivoslider4wp_text_headline); ?></strong><br />
			<br />
